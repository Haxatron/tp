...
public class CommandTestUtil {
    ...
    public static final String INVALID_TELEGRAM_DESC = " " + PREFIX_TELEGRAM + "amy!bee"; // invalid char
    public static final String INVALID_TYPE_DESC = " " + PREFIX_TYPE + "student123"; // invalid type
    public static final String INVALID_SESSION_DESC = " " + PREFIX_SESSION; // empty string
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withType(VALID_TYPE_STUDENT)
                .withTelegram(VALID_TELEGRAM_AMY).withSession(VALID_SESSION_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withType(VALID_TYPE_TA)
                .withTelegram(VALID_TELEGRAM_BOB).withSession(VALID_SESSION_BOB).build();
    }
